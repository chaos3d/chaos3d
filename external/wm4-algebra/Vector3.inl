...
//----------------------------------------------------------------------------
template <class Real>
Vector3<Real>::Vector3 (const Vector4<Real>& rkV)
{
    m_afTuple[0] = rkV[0];
    m_afTuple[1] = rkV[1];
    m_afTuple[2] = rkV[2];
    ...
    const Vector3& rkW)
{
    ...
    if (fabs(rkW.m_afTuple[0]) >=
        fabs(rkW.m_afTuple[1]) )
    {
        // W.x or W.z is the largest magnitude component, swap them
        fInvLength = (Real)1.0/sqrt(rkW.m_afTuple[0]*rkW.m_afTuple[0] +
    ...
    else
    {
        ...
        fInvLength = (Real)1.0/sqrt(rkW.m_afTuple[1]*rkW.m_afTuple[1] +
            rkW.m_afTuple[2]*rkW.m_afTuple[2]);
