        ...
        else
        {
            ...
            if (m_afEntry[0] >= m_afEntry[4])
            {
                ...
                if (m_afEntry[0] >= m_afEntry[8])
                {
                    ...
                    rkAxis[0] = ((Real)0.5)*sqrt(m_afEntry[0] -
                ...
                else
                {
                    ...
                    rkAxis[2] = ((Real)0.5)*sqrt(m_afEntry[8] -
            ...
            else
            {
                ...
                if (m_afEntry[4] >= m_afEntry[8])
                {
                    ...
                    rkAxis[1] = ((Real)0.5)*sqrt(m_afEntry[4] -
...
void Matrix3<Real>::Orthonormalize ()
{
    ...
    // compute q0
    Real fInvLength = (Real)1.0/sqrt(m_afEntry[0]*m_afEntry[0] +
    ...
    fInvLength = (Real)1.0/sqrt(m_afEntry[1]*m_afEntry[1] +
    ...
    fInvLength = (Real)1.0/sqrt(m_afEntry[2]*m_afEntry[2] +
    ...
    Real& rfXAngle, Real& rfZAngle, Real& rfYAngle) const
{
    ...
    if (m_afEntry[1] < (Real)1.0)
    {
        if (m_afEntry[1] > -(Real)1.0)
        {
            ...
            rfXAngle = atan2(m_afEntry[7],m_afEntry[4]);
            rfYAngle = atan2(m_afEntry[2],m_afEntry[0]);
            return EA_UNIQUE;
        }
        else
        {
            ...
            rfXAngle = -atan2(-m_afEntry[6],m_afEntry[8]);
            rfYAngle = (Real)0.0;
            return EA_NOT_UNIQUE_DIF;
        }
    }
    ...
    Real& rfYAngle, Real& rfXAngle, Real& rfZAngle) const
{
    ...
    if (m_afEntry[5] < (Real)1.0)
    {
        if (m_afEntry[5] > -(Real)1.0)
        {
            ...
            rfYAngle = atan2(m_afEntry[2],m_afEntry[8]);
            rfZAngle = atan2(m_afEntry[3],m_afEntry[4]);
            return EA_UNIQUE;
        }
        else
        {
            ...
            rfYAngle = -atan2(-m_afEntry[1],m_afEntry[0]);
            rfZAngle = (Real)0.0;
            return EA_NOT_UNIQUE_DIF;
        }
    }
    ...
    Real& rfYAngle, Real& rfZAngle, Real& rfXAngle) const
{
    ...
    if (m_afEntry[3] < (Real)1.0)
    {
        if (m_afEntry[3] > -(Real)1.0)
        {
            ...
            rfYAngle = atan2(-m_afEntry[6],m_afEntry[0]);
            rfXAngle = atan2(-m_afEntry[5],m_afEntry[4]);
            return EA_UNIQUE;
        }
        else
        {
            ...
            rfZAngle = (Real)-HALF_PI;
            rfYAngle = -atan2(m_afEntry[7],m_afEntry[8]);
            rfXAngle = (Real)0.0;
            return EA_NOT_UNIQUE_DIF;
        }
    }
    ...
    Real& rfZAngle, Real& rfXAngle, Real& rfYAngle) const
{
    ...
    if (m_afEntry[7] < (Real)1.0)
    {
        if (m_afEntry[7] > -(Real)1.0)
        {
            ...
            rfZAngle = atan2(-m_afEntry[1],m_afEntry[4]);
            rfYAngle = atan2(-m_afEntry[6],m_afEntry[8]);
            return EA_UNIQUE;
        }
        else
        {
            ...
            // WARNING.  The solution is not unique.  Choosing y_angle = 0.
            rfXAngle = (Real)-HALF_PI;
            rfZAngle = -atan2(m_afEntry[2],m_afEntry[0]);
            rfYAngle = (Real)0.0;
            return EA_NOT_UNIQUE_DIF;
        }
    }
    ...
    Real& rfZAngle, Real& rfYAngle, Real& rfXAngle) const
{
    ...
    if (m_afEntry[6] < (Real)1.0)
    {
        if (m_afEntry[6] > -(Real)1.0)
        {
            ...
            rfZAngle = atan2(m_afEntry[3],m_afEntry[0]);
            rfXAngle = atan2(m_afEntry[7],m_afEntry[8]);
            return EA_UNIQUE;
        }
        else
        {
            ...
            // WARNING.  The solution is not unique.  Choosing x_angle = 0.
            rfYAngle = (Real)HALF_PI;
            rfZAngle = -atan2(m_afEntry[1],m_afEntry[2]);
            rfXAngle = (Real)0.0;
            return EA_NOT_UNIQUE_DIF;
        }
    }
    ...
    Real& rfX0Angle, Real& rfYAngle, Real& rfX1Angle) const
{
    ...
    if (m_afEntry[0] < (Real)1.0)
    {
        if (m_afEntry[0] > -(Real)1.0)
        {
            ...
            rfX0Angle = atan2(m_afEntry[3],-m_afEntry[6]);
            rfX1Angle = atan2(m_afEntry[1],m_afEntry[2]);
            return EA_UNIQUE;
        }
        else
        {
            ...
            rfYAngle = (Real)M_PI;
            rfX0Angle = -atan2(-m_afEntry[5],m_afEntry[4]);
            rfX1Angle = (Real)0.0;
            return EA_NOT_UNIQUE_DIF;
        }
    }
    ...
    Real& rfX0Angle, Real& rfZAngle, Real& rfX1Angle) const
{
    ...
    if (m_afEntry[0] < (Real)1.0)
    {
        if (m_afEntry[0] > -(Real)1.0)
        {
            ...
            rfX0Angle = atan2(m_afEntry[6],m_afEntry[3]);
            rfX1Angle = atan2(m_afEntry[2],-m_afEntry[1]);
            return EA_UNIQUE;
        }
        else
        {
            ...
            rfZAngle = (Real)M_PI;
            rfX0Angle = -atan2(m_afEntry[7],m_afEntry[8]);
            rfX1Angle = (Real)0.0;
            return EA_NOT_UNIQUE_DIF;
        }
    }
    ...
    Real& rfY0Angle, Real& rfXAngle, Real& rfY1Angle) const
{
    ...
    if (m_afEntry[4] < (Real)1.0)
    {
        if (m_afEntry[4] > -(Real)1.0)
        {
            ...
            rfY0Angle = atan2(m_afEntry[1],m_afEntry[7]);
            rfY1Angle = atan2(m_afEntry[3],-m_afEntry[5]);
            return EA_UNIQUE;
        }
        else
        {
            ...
            rfXAngle = (Real)M_PI;
            rfY0Angle = atan2(m_afEntry[2],m_afEntry[0]);
            rfY1Angle = (Real)0.0;
            return EA_NOT_UNIQUE_DIF;
        }
    }
    ...
    Real& rfY0Angle, Real& rfZAngle, Real& rfY1Angle) const
{
    ...
    if (m_afEntry[4] < (Real)1.0)
    {
        if (m_afEntry[4] > -(Real)1.0)
        {
            ...
            rfY0Angle = atan2(m_afEntry[7],-m_afEntry[1]);
            rfY1Angle = atan2(m_afEntry[5],m_afEntry[3]);
            return EA_UNIQUE;
        }
        else
        {
            ...
            rfZAngle = (Real)M_PI;
            rfY0Angle = -atan2(-m_afEntry[6],m_afEntry[8]);
            rfY1Angle = (Real)0.0;
            return EA_NOT_UNIQUE_DIF;
        }
    }
    ...
    Real& rfZ0Angle, Real& rfXAngle, Real& rfZ1Angle) const
{
    ...
    if (m_afEntry[8] < (Real)1.0)
    {
        if (m_afEntry[8] > -(Real)1.0)
        {
            ...
            rfZ0Angle = atan2(m_afEntry[2],-m_afEntry[5]);
            rfZ1Angle = atan2(m_afEntry[6],m_afEntry[7]);
            return EA_UNIQUE;
        }
        else
        {
            ...
            rfXAngle = (Real)M_PI;
            rfZ0Angle = -atan2(-m_afEntry[1],m_afEntry[0]);
            rfZ1Angle = (Real)0.0;
            return EA_NOT_UNIQUE_DIF;
        }
    }
    ...
    Real& rfZ0Angle, Real& rfYAngle, Real& rfZ1Angle) const
{
    ...
    if (m_afEntry[8] < (Real)1.0)
    {
        if (m_afEntry[8] > -(Real)1.0)
        {
            ...
            rfZ0Angle = atan2(m_afEntry[5],m_afEntry[2]);
            rfZ1Angle = atan2(m_afEntry[7],-m_afEntry[6]);
            return EA_UNIQUE;
        }
        else // r22 = -1
        {
            ...
            rfYAngle = (Real)M_PI;
            rfZ0Angle = -atan2(m_afEntry[3],m_afEntry[4]);
            rfZ1Angle = (Real)0.0;
            return EA_NOT_UNIQUE_DIF;
        }
    }
...
bool Matrix3<Real>::QLAlgorithm (Real afDiag[3], Real afSubd[2])
{
    ...
    for (int i = 0; i < iMax; i++)
    {
        ...
        fSum = fabs(afDiag[0]) + fabs(afDiag[1]);
        if (fabs(afSubd[0]) + fSum == fSum)
        {
            ...
            fTmp = (Real)1.0/sqrt(fCos*fCos + fSin*fSin);
            fCos *= fTmp;
            fSin *= fTmp;
        ...
        fSum = fabs(afDiag[1]) + fabs(afDiag[2]);
        if (fabs(afSubd[1]) + fSum == fSum)
        {
            // The matrix is effectively
            //       +-         -+
            //   M = | d0  s0  0 |
        ...
        Real fRoot = sqrt((Real)1.0 + fRatio*fRatio);
        Real fB = afSubd[1];
        ...
        {
            fRatio = fA/fB;
            fSin = (Real)1.0/sqrt((Real)1.0 + fRatio*fRatio);
            fCos = fRatio*fSin;
        }
        else
        {
            fRatio = fB/fA;
            fCos = (Real)1.0/sqrt((Real)1.0 + fRatio*fRatio);
            fSin = fRatio*fCos;
        }
        ...
        {
            fRatio = fA/fB;
            fRoot = sqrt((Real)1.0 + fRatio*fRatio);
            afSubd[1] = fB*fRoot;
            fSin = ((Real)1.0)/fRoot;
            fCos = fRatio*fSin;
        }
    ...
    Matrix3& rkU) const
{
    ...
    fInvLength = (Real)1.0/sqrt(rkQ[0][1]*rkQ[0][1] +
    ...
    fInvLength = (Real)1.0/sqrt(rkQ[0][2]*rkQ[0][2] +
