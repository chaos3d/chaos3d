...
//----------------------------------------------------------------------------
template <class Real>
Matrix4<Real>::Matrix4 (Matrix3<Real> const& rtMat){
	memset( m_afEntry, 0 ,sizeof(m_afEntry) );
	memcpy( m_afEntry, (float const*)rtMat, sizeof(Real)*3 );
	memcpy( m_afEntry + 4, (float const*)rtMat + 3, sizeof(Real)*3 );
	memcpy( m_afEntry + 8, (float const*)rtMat + 6, sizeof(Real)*3 );
	m_afEntry[15] = (Real)1;
}
...
//----------------------------------------------------------------------------
template <class Real>
inline Vector3<Real> Matrix4<Real>::ToTransform() const{
