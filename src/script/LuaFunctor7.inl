...
class CHAOS_API ApplierRA7 : public LuaFunctor{
protected:
	typedef		R (*TFnPtr)(A1,A2,A3,A4,A5,A6,A7);
	typedef		ApplierRA7<R,A1,A2,A3,A4,A5,A6,A7> SELF;
	TFnPtr		mPtr;

public:
	ApplierRA7( TFnPtr ptr ): LuaFunctor(SELF::lua_call), mPtr(ptr){
	};
...
class CHAOS_API ApplierRA7<void, A1, A2, A3, A4, A5, A6, A7> : public LuaFunctor{
protected:
	typedef		void (*TFnPtr)(A1,A2,A3,A4,A5,A6,A7);
	typedef		ApplierRA7<void,A1,A2,A3,A4,A5,A6,A7> SELF;
	TFnPtr		mPtr;
...
class CHAOS_API ApplierCRA7 : public LuaFunctor{
protected:
	typedef		R (C::*TFnPtr)(A1,A2,A3,A4,A5,A6,A7);
	typedef		ApplierCRA7<C,R,A1,A2,A3,A4,A5,A6,A7> SELF;
	TFnPtr		mPtr;

public:
	ApplierCRA7( TFnPtr ptr ): LuaFunctor(SELF::lua_call), mPtr(ptr){
	};
...
class CHAOS_API ApplierCRA7<C, void, A1, A2, A3, A4, A5, A6, A7> : public LuaFunctor{
protected:
	typedef		void (C::*TFnPtr)(A1,A2,A3,A4,A5,A6,A7);
	typedef		ApplierCRA7<C,void,A1,A2,A3,A4,A5,A6,A7> SELF;
	TFnPtr		mPtr;
