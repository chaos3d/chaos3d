...
class CHAOS_API ApplierRA5 : public LuaFunctor{
protected:
	typedef		R (*TFnPtr)(A1,A2,A3,A4,A5);
	typedef		ApplierRA5<R,A1,A2,A3,A4,A5> SELF;
	TFnPtr		mPtr;

public:
	ApplierRA5( TFnPtr ptr ): LuaFunctor(SELF::lua_call), mPtr(ptr){
	};
...
class CHAOS_API ApplierRA5<void, A1, A2, A3, A4, A5> : public LuaFunctor{
protected:
	typedef		void (*TFnPtr)(A1,A2,A3,A4,A5);
	typedef		ApplierRA5<void,A1,A2,A3,A4,A5> SELF;
	TFnPtr		mPtr;
...
class CHAOS_API ApplierCRA5 : public LuaFunctor{
protected:
	typedef		R (C::*TFnPtr)(A1,A2,A3,A4,A5);
	typedef		ApplierCRA5<C,R,A1,A2,A3,A4,A5> SELF;
	TFnPtr		mPtr;

public:
	ApplierCRA5( TFnPtr ptr ): LuaFunctor(SELF::lua_call), mPtr(ptr){
	};
...
class CHAOS_API ApplierCRA5<C, void, A1, A2, A3, A4, A5> : public LuaFunctor{
protected:
	typedef		void (C::*TFnPtr)(A1,A2,A3,A4,A5);
	typedef		ApplierCRA5<C,void,A1,A2,A3,A4,A5> SELF;
	TFnPtr		mPtr;
